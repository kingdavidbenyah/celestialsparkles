  ...
  return (
    <section>
      <div
        ...
        style={{ width: "clamp(170px, 34vw, 245px)" }}
      >
        {/* image */}
        <div
        ...
        >
          ...
          {product.availability ? (
            <button
              ...
              className="absolute flex items-center justify-center gap-2 text-gray-100 font-medium bg-black/30 inset-0 rounded-[15px] opacity-0 hover:opacity-100 w-full h-full transition ease-in-out  hover:cursor-pointer z-10"
            >
              Buy Now
              <span>
                <TbExternalLink />
        ...
        <div className="px-3 pb-3">
          ...
          >
            {/* newarrival, brand, rating, and name */}
            <ul className="flex flex-col gap-0.5 md:gap-1">
              {/* newarrival??? */}
              {product.group == "newarrivals" ? (
                <p
                  style={{ fontSize: "clamp(10px, 1.825vw, 13px)" }}
                  className="text-[#FF3333] font-medium" 
                >
                  New                </p>
              ) : null}
              {/* brand and rating */}
              <div className="flex justify-between items-center">
                <p
                  className="font-mont font-semibold uppercase"
          ...
          {product.availability ? (
            <button
              ...
              } mt-3 py-2 w-full text-white rounded-md hover:cursor-pointer`}
            >
